...
NRFLite _radio; // Provide a serial object so the radio can print to the serial monitor.

void setup()
{
    Serial.begin(9600);

    if (!_radio.init(RADIO_ID, PIN_RADIO_CE, PIN_RADIO_CSN, NRFLite::BITRATE2MBPS, 0))
    {
