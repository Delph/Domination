...
#define ST7735_CS_PIN   A1      // <= /CS pin (chip-select, LOW to get attention of ST7735, HIGH and it ignores SPI bus)
#define ST7735_DC_PIN   A0     // <= DC pin (1=data or 0=command indicator line) also called RS
...
#define ST7735_SAVE_SPI_SETTINGS  1     // <= 0/1 with 1 to save/restore AVR SPI control register (to "play nice" when other SPI use)
